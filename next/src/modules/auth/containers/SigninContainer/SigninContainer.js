...
import { combine, condition, required, minLength, email, equalsField, name } from 'app/lib/form/validation'
...
const validations = {
  name: combine([required, name]),
  email: combine([required, email]),
  password: combine([required, minLength(6), name]),
