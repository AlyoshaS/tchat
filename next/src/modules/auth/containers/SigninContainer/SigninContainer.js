...
import { combine, condition, required, minLength, email, equalsField, fieldValitation } from 'app/lib/form/validation'
...
const validations = {
  name: combine([required, fieldValitation]),
  email: combine([required, email]),
  password: combine([required, minLength(6), fieldValitation]),
